    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-6 text-center font-sans">
        ...
        <div className="flex gap-4">
          <button
            onClick={fetchData}
            className="bg-[#00b96b] hover:bg-[#009b59] text-white font-bold tracking-widest uppercase text-xs py-3 px-6 rounded-md transition-colors cursor-pointer shadow-sm"
          >
            Retry Connection
          </button>
          {onBackToPortal && (
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-4">
        <motion.div
          ...
          className="mb-4"
        >
          <RefreshCw className="w-12 h-12 text-[#00b96b]" />
        </motion.div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-2 italic font-sans text-sm">Mapping International Baccalaureate Geography Intelligence</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-200 dark:bg-slate-900 flex flex-col font-sans text-slate-900 dark:text-slate-100 overflow-x-hidden">
      ...
      <header className="h-20 bg-white dark:bg-slate-950 flex items-center justify-between px-6 border-b border-slate-300 dark:border-slate-800 flex-shrink-0 sticky top-0 z-50">
        <div className="flex items-center space-x-4">
          <div className="bg-[#00b96b] w-12 h-12 rounded-xl flex items-center justify-center shadow-lg shadow-[#00b96b]/20">
            <span className="text-white font-bold text-xl tracking-tighter">DP</span>
          </div>
          <div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center bg-transparent border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors">
            <div className="w-8 h-8 rounded-full bg-green-100 dark:bg-[#00b96b]/10 flex items-center justify-center text-[#00b96b] mr-3">
            ...
            <div className="text-left">
              ...
              <p className="text-[9px] font-bold text-[#00b96b] tracking-wider uppercase">
      ...
      <div className="px-4 pt-6 pb-1">
        <div className="flex items-center gap-2">
          <Globe className="w-5 h-5 text-[#00b96b] dark:text-[#00d87c]" />
      ...
      <footer className="bg-white dark:bg-slate-950 border-t border-slate-300 dark:border-slate-800 px-6 py-2 flex items-center justify-between text-[10px] font-bold text-slate-400 sticky bottom-0 z-40">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <button 
            onClick={fetchData}
            disabled={loading}
            className="flex items-center gap-1 hover:text-[#00b96b] transition-colors"
          >

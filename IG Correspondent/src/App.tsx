                        ...
                        <div className="flex items-center justify-between gap-2 pt-1 flex-wrap">
                          ...
                          {activeTeacherCode && (
                            <button
                              ...
                              className="px-2 py-1.5 rounded-md border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 text-slate-500 hover:text-[#2563eb] dark:hover:text-[#60a5fa] hover:bg-slate-100 dark:hover:bg-slate-800 transition-all cursor-pointer inline-flex items-center gap-1.5 text-[9.5px] font-black uppercase tracking-wider shadow-sm opacity-0 group-hover:opacity-100 focus:opacity-100"
                              title="Edit Tags"
                            >

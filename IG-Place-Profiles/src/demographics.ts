...
export const demographicsMap: Record<string, DemographicInfo> = {
  'bangladesh': {
    religion: [
      { name: "Muslim", pct: 90.4, color: "bg-emerald-500" },
    ...
    ethnic: [
      { name: "Bengali", pct: 98.0, color: "bg-emerald-600" },
  ...
  'usa': {
    religion: [
      ...
      { name: "Muslim", pct: 1.0, color: "bg-emerald-500" },
  ...
  'china': {
    religion: [
      ...
      { name: "Muslim", pct: 1.8, color: "bg-emerald-500" }
    ],
    ethnic: [
      { name: "Han Chinese", pct: 91.1, color: "bg-red-600" },
      { name: "Uyghur", pct: 0.8, color: "bg-emerald-500" },
  ...
  'india': {
    religion: [
      ...
      { name: "Muslim", pct: 14.2, color: "bg-emerald-500" },
  ...
  'vietnam': {
    ...
    ethnic: [
      ...
      { name: "Muong", pct: 1.5, color: "bg-emerald-500" },
  ...
  'philippines': {
    religion: [
      ...
      { name: "Muslim", pct: 6.4, color: "bg-emerald-500" },
  ...
  'malaysia': {
    religion: [
      { name: "Muslim", pct: 61.3, color: "bg-emerald-500" },
    ...
    ethnic: [
      { name: "Bumiputera", pct: 69.7, color: "bg-emerald-600" },
  ...
  'russia': {
    religion: [
      ...
      { name: "Muslim", pct: 12.0, color: "bg-emerald-500" },
    ...
    ethnic: [
      ...
      { name: "Tatar", pct: 3.7, color: "bg-emerald-600" },
  ...
  'germany': {
    religion: [
      ...
      { name: "Muslim", pct: 5.5, color: "bg-emerald-500" },
    ...
    ethnic: [
      ...
      { name: "Syrian", pct: 0.5, color: "bg-emerald-500" },
  ...
  'uk': {
    religion: [
      ...
      { name: "Muslim", pct: 6.5, color: "bg-emerald-500" },
  ...
  'switzerland': {
    religion: [
      ...
      { name: "Muslim", pct: 5.4, color: "bg-emerald-500" },
      { name: "Others", pct: 3.9, color: "bg-indigo-400" }
    ],
    ethnic: [
      { name: "Swiss", pct: 75.1, color: "bg-red-500" },
      { name: "Italian", pct: 3.7, color: "bg-emerald-500" },
  ...
  'australia': {
    religion: [
      ...
      { name: "Muslim", pct: 3.2, color: "bg-emerald-500" },
    ...
    ethnic: [
      ...
      { name: "Australian", pct: 29.9, color: "bg-emerald-600" },
  ...
  'brazil': {
    religion: [
      ...
      { name: "Protestant/Evan.", pct: 22.2, color: "bg-emerald-500" },
  ...
  'canada': {
    religion: [
      ...
      { name: "Muslim", pct: 4.9, color: "bg-emerald-500" },
    ...
    ethnic: [
      ...
      { name: "Indigenous", pct: 5.0, color: "bg-emerald-600" },
  ...
  'drc': {
    religion: [
      ...
      { name: "Protestant", pct: 40.0, color: "bg-emerald-500" },
  ...
  'south-africa': {
    religion: [
      ...
      { name: "Muslim", pct: 1.9, color: "bg-emerald-500" },
      { name: "Hindu", pct: 0.9, color: "bg-orange-500" },
      { name: "Others", pct: 0.6, color: "bg-zinc-400" }
    ],
    ethnic: [
      { name: "Black African", pct: 81.4, color: "bg-emerald-600" },
  ...
  'ethiopia': {
    religion: [
      ...
      { name: "Muslim", pct: 31.3, color: "bg-emerald-500" },
    ...
    ethnic: [
      { name: "Oromo", pct: 34.9, color: "bg-emerald-600" },
  ...
  'sudan': {
    religion: [
      { name: "Muslim (Sunni)", pct: 97.0, color: "bg-emerald-500" },
      { name: "Christian/Trad.", pct: 3.0, color: "bg-blue-500" }
    ],
    ethnic: [
      { name: "Sudanese Arab", pct: 70.0, color: "bg-emerald-600" },
      { name: "Fur, Beja, Nuba, etc.", pct: 30.0, color: "bg-amber-500" }
    ]
  },
  'chad': {
    religion: [
      { name: "Muslim", pct: 52.1, color: "bg-emerald-500" },
    ...
    ethnic: [
      { name: "Sara", pct: 27.7, color: "bg-emerald-600" },
  ...
  'niger': {
    religion: [
      { name: "Muslim (Sunni)", pct: 99.3, color: "bg-emerald-500" },
      { name: "Traditional", pct: 0.4, color: "bg-amber-600" },
      { name: "Christian", pct: 0.3, color: "bg-blue-500" }
    ],
    ethnic: [
      { name: "Hausa", pct: 53.1, color: "bg-emerald-600" },
  ...
  'iceland': {
    ...
    ethnic: [
      { name: "Icelandic", pct: 91.0, color: "bg-emerald-600" },
  ...
  'tuvalu': {
    religion: [
      ...
      { name: "Seventh-day Adventist & Other", pct: 3.0, color: "bg-emerald-500" }
    ],
    ethnic: [
      { name: "Tuvaluan (Polynesian)", pct: 96.0, color: "bg-emerald-600" },
  ...
  'peru': {
    ...
    ethnic: [
      { name: "Mestizo (mixed)", pct: 60.2, color: "bg-emerald-600" },
  ...
  'rwanda': {
    religion: [
      ...
      { name: "Muslim", pct: 2.0, color: "bg-emerald-500" },
      { name: "None / Other", pct: 2.1, color: "bg-slate-400" }
    ],
    ethnic: [
      { name: "Hutu", pct: 84.0, color: "bg-emerald-600" },
  ...
  'kenya': {
    religion: [
      ...
      { name: "Muslim", pct: 10.9, color: "bg-emerald-500" },
      { name: "Traditional / No Belief", pct: 3.6, color: "bg-amber-600" }
    ],
    ethnic: [
      { name: "Kikuyu", pct: 17.1, color: "bg-emerald-600" },
  ...
  'thailand': {
    ...
    ethnic: [
      { name: "Thai", pct: 90.0, color: "bg-emerald-600" },
  ...
  'belgium': {
    religion: [
      ...
      { name: "Muslim", pct: 6.8, color: "bg-emerald-500" },
      { name: "Others", pct: 6.8, color: "bg-zinc-400" }
    ],
    ethnic: [
      { name: "Flemish", pct: 58.0, color: "bg-emerald-600" },
  ...
  'france': {
    religion: [
      ...
      { name: "Muslim", pct: 4.0, color: "bg-emerald-500" },
      { name: "Others", pct: 9.0, color: "bg-zinc-400" }
    ],
    ethnic: [
      { name: "French (Native European)", pct: 85.0, color: "bg-emerald-600" },
  ...
  'netherlands': {
    religion: [
      ...
      { name: "Muslim", pct: 5.6, color: "bg-emerald-500" },
      { name: "Others", pct: 5.3, color: "bg-zinc-400" }
    ],
    ethnic: [
      { name: "Dutch", pct: 76.2, color: "bg-emerald-600" },
  ...
  'singapore': {
    religion: [
      ...
      { name: "Muslim", pct: 15.6, color: "bg-emerald-500" },
      { name: "Hindu", pct: 5.0, color: "bg-orange-500" },
      { name: "Others", pct: 0.6, color: "bg-zinc-400" }
    ],
    ethnic: [
      { name: "Chinese", pct: 74.3, color: "bg-emerald-600" },
  ...
  'uae': {
    religion: [
      { name: "Muslim (Sunni & Shi'a)", pct: 76.0, color: "bg-emerald-500" },
    ...
    ethnic: [
      ...
      { name: "Emirati Citizen", pct: 11.6, color: "bg-emerald-600" },
  ...
  'saudi-arabia': {
    religion: [
      { name: "Muslim (Official religion)", pct: 93.0, color: "bg-emerald-500" },
      { name: "Other religions (Expatriates)", pct: 7.0, color: "bg-slate-400" }
    ],
    ethnic: [
      { name: "Saudi Arab Citizen", pct: 62.1, color: "bg-emerald-600" },
      { name: "Expatriate Workers (South/Southeast Asian, Arab)", pct: 37.9, color: "bg-slate-400" }
    ]
  },
  'turkey': {
    religion: [
      { name: "Muslim (Sunni / Alevi)", pct: 98.6, color: "bg-emerald-500" },
      { name: "None / Other", pct: 1.4, color: "bg-slate-400" }
    ],
    ethnic: [
      { name: "Turkish", pct: 75.0, color: "bg-emerald-600" },
  ...
  'egypt': {
    religion: [
      { name: "Muslim (Predominantly Sunni)", pct: 90.0, color: "bg-emerald-500" },
  ...
  'ukraine': {
    religion: [
      ...
      { name: "Islam & Jewish", pct: 2.0, color: "bg-emerald-500" }
    ],
    ethnic: [
  ...
  'indonesia': {
    religion: [
      { name: "Muslim", pct: 87.0, color: "bg-emerald-500" },
    ...
    ethnic: [
      { name: "Javanese", pct: 40.1, color: "bg-emerald-600" },
  ...
  'iran': {
    religion: [
      { name: "Muslim (Shia)", pct: 90.0, color: "bg-emerald-600" },
      { name: "Muslim (Sunni)", pct: 9.0, color: "bg-emerald-400" },
  ...
  'ireland': {
    religion: [
      ...
      { name: "Muslim", pct: 1.6, color: "bg-emerald-500" },
      { name: "Others", pct: 6.4, color: "bg-zinc-400" }
    ],
    ethnic: [
      { name: "White Irish", pct: 77.0, color: "bg-emerald-600" },
  ...
  'italy': {
    ...
    ethnic: [
      { name: "Italian (Native)", pct: 92.0, color: "bg-emerald-600" },
  ...
  'israel': {
    religion: [
      ...
      { name: "Muslim", pct: 18.1, color: "bg-emerald-500" },
    ...
    ethnic: [
      ...
      { name: "Arab", pct: 21.0, color: "bg-emerald-600" },
  ...
  'japan': {
    ...
    ethnic: [
      ...
      { name: "Korean", pct: 0.4, color: "bg-emerald-500" },

  ...
  app.use((req, res, next) => {
    ...
    app.post("/api/generate", upload.single('attachment'), async (req: any, res) => {
      ...
      const systemInstruction = `
        # PERSONA & OBJECTIVE
        You are the AI engine powering "DP Student Scaffold," an expert educational assistant designed exclusively for International B Diploma Programme (IB DP) students. 
